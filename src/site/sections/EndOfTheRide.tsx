// Generated from `Qafilaa Site v3.dc.html` (handoff 14), lines 855-882.
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0,1fr) auto', gap: '52px', alignItems: 'start' }} data-cols="1">
          <div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px', marginTop: '24px', flexWrap: 'wrap' }}>
              <div data-seg="1" style={{ display: 'flex', gap: '6px', padding: '5px', background: 'color-mix(in srgb, var(--ink) 7%, transparent)', borderRadius: '999px' }} data-cardtabs="1"></div>
              <button data-carddark="1" data-btn="1" type="button" aria-pressed="false" style={{ display: 'flex', alignItems: 'center', gap: '7px', height: '44px', padding: '0 14px', border: '1px solid var(--line)', borderRadius: '999px', background: 'transparent', color: 'var(--mut)', font: '600 12px \'Hanken Grotesk\'', cursor: 'pointer' }}>
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M21 12.8A9 9 0 1 1 11.2 3a7 7 0 0 0 9.8 9.8Z"></path></svg>Dark
              </button>
            </div>
