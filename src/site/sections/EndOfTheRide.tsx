// Generated from `Qafilaa Site v2.dc.html` (handoff 11), lines 755-782.
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0,1fr) auto', gap: '52px', alignItems: 'start' }} data-cols="1">
          <div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px', marginTop: '24px', flexWrap: 'wrap' }}>
              <div style={{ display: 'flex', gap: '6px', padding: '5px', background: 'color-mix(in srgb, var(--ink) 7%, transparent)', borderRadius: '999px' }} data-cardtabs="1"></div>
              <button data-carddark="1" type="button" aria-pressed="false" style={{ display: 'flex', alignItems: 'center', gap: '7px', height: '44px', padding: '0 14px', border: '1px solid var(--line)', borderRadius: '999px', background: 'transparent', color: 'var(--mut)', font: '600 12px \'Hanken Grotesk\'', cursor: 'pointer' }}>
