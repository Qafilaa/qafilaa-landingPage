// Generated from `Qafilaa Site v2.dc.html` (handoff 11), lines 647-688.
  ...
  return (
    <section id="safety" data-sec="Safety" data-tone="night" data-pad="1" style={{ position: 'relative', zIndex: '5', padding: '118px 56px 118px 132px', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative' }}>
          ...
          <div style={{ display: 'flex', gap: '26px', alignItems: 'center', justifyContent: 'center', marginTop: '56px' }} data-strip="1">
          ...
          <div style={{ display: 'flex', gap: '20px', alignItems: 'center', justifyContent: 'center', marginTop: '32px', flexWrap: 'wrap' }}>
            <div data-sosdial="1" style={{ position: 'relative', width: '78px', height: '78px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <svg width="78" height="78" viewBox="0 0 78 78" style={{ position: 'absolute', inset: '0', transform: 'rotate(-90deg)' }} aria-hidden="true">
                <circle cx="39" cy="39" r="34" fill="none" stroke="rgba(247,245,240,.14)" strokeWidth="5"></circle>
              ...
              <span data-sosnum="1" style={{ fontFamily: '\'Space Grotesk\',sans-serif', fontSize: '24px', fontWeight: '600', fontVariantNumeric: 'tabular-nums', color: 'var(--ink)' }}>—</span>
            </div>
            <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
              <button data-sosrun="1" data-magnet="1" data-tap="1" style={{ padding: '14px 24px', border: '1px solid #E5392E', borderRadius: '12px', background: 'rgba(229,57,46,.14)', color: '#FF8177', font: '600 15px \'Hanken Grotesk\'', cursor: 'pointer' }}>Run the crash sequence</button>
              <button data-soscancel="1" data-tap="1" style={{ padding: '14px 24px', border: '1px solid var(--line)', borderRadius: '12px', background: 'transparent', color: 'var(--mut)', font: '600 15px \'Hanken Grotesk\'', cursor: 'pointer' }}>I'm OK, cancel</button>
              <button data-sosreset="1" data-tap="1" style={{ padding: '14px 24px', border: '1px solid var(--line)', borderRadius: '12px', background: 'transparent', color: 'var(--mut)', font: '600 15px \'Hanken Grotesk\'', cursor: 'pointer' }}>Reset</button>
            </div>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(260px,1fr))', gap: '20px', marginTop: '56px', maxWidth: '1240px' }}>
