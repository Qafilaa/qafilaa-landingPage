// Generated from `Qafilaa Site v3.dc.html` (handoff 14), lines 747-788.
  ...
  return (
    <section id="safety" data-sec="Safety" data-tone="night" data-pad="1" style={{ position: 'relative', zIndex: '5', padding: '118px 56px 118px 132px', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative' }}>
          ...
          <p data-rv="1" style={{ fontSize: 'var(--qf-fs-18)', lineHeight: '1.65', color: 'var(--mut)', maxWidth: '66ch', margin: '24px 0 0' }}>A crash alert goes to the riders closest to you first, with your position, your bearing and your blood group. If there is no signal, it queues and fires the moment any rider in the convoy gets a bar.</p>
          ...
          <div style={{ display: 'flex', gap: '20px', alignItems: 'center', justifyContent: 'center', marginTop: '32px', flexWrap: 'wrap' }}>
            ...
            <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
              ...
              <button data-soscancel="1" data-btn="1" data-tap="1" style={{ padding: '14px 24px', border: '1px solid var(--line)', borderRadius: '12px', background: 'transparent', color: 'var(--mut)', font: '600 15px \'Hanken Grotesk\'', cursor: 'pointer' }}>I'm OK, cancel</button>
