// Generated from `Qafilaa Site v3.dc.html` (handoff 14), lines 555-582.
...
export function TheMoney() {
  return (
    <section id="money" data-sec="The money" data-tone="light" data-pad="1" style={{ position: 'relative', zIndex: '5', padding: '110px 56px 110px 132px' }}>
        <div data-plot="1" style={{ fontFamily: '\'Space Grotesk\',sans-serif', fontSize: 'var(--qf-fs-11)', letterSpacing: '.14em', textTransform: 'uppercase', color: 'var(--sur)', marginBottom: '24px' }}>Waypoint 09 · Settled before you are home</div>
          ...
          <div>
            ...
            <div style={{ marginTop: '28px', background: 'var(--card)', border: '1px solid var(--line)', borderRadius: '18px', padding: '24px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'baseline', gap: '12px', marginTop: '20px', flexWrap: 'wrap' }}>
                ...
                <span data-splitpayer="1" style={{ fontFamily: '\'Space Grotesk\',sans-serif', fontSize: 'var(--qf-fs-11)', letterSpacing: '.14em', textTransform: 'uppercase', color: 'var(--sur)' }}>paid by Akash</span>
              </div>
            ...
            <div data-rv="1" style={{ display: 'flex', flexWrap: 'wrap', gap: '8px 14px', marginTop: '18px', maxWidth: '680px', fontFamily: '\'Space Grotesk\',sans-serif', fontSize: 'var(--qf-fs-11)', letterSpacing: '.14em', textTransform: 'uppercase', color: 'var(--sur)' }}>
