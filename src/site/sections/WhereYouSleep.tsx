// Generated from `Qafilaa Site v3.dc.html` (handoff 14), lines 542-552.
...
export function WhereYouSleep() {
  return (
    <section id="stays" data-sec="Where you sleep" data-tone="paper" data-pad="1" style={{ position: 'relative', zIndex: '5', padding: '110px 56px 110px 132px' }}>
        <div data-plot="1" style={{ fontFamily: '\'Space Grotesk\',sans-serif', fontSize: 'var(--qf-fs-11)', letterSpacing: '.14em', textTransform: 'uppercase', color: 'var(--sur)', marginBottom: '24px' }}>Waypoint 08 · Where you sleep</div>
