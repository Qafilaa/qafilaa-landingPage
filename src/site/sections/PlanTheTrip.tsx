// Generated from `Qafilaa Site v2.dc.html` (handoff 11), lines 381-395.
...
export function PlanTheTrip() {
  return (
    <section id="plan" data-sec="Plan the trip" data-tone="light" data-pad="1" style={{ position: 'relative', zIndex: '5', padding: '110px 56px 110px 132px' }}>
        <div data-plot="1" style={{ fontFamily: '\'Space Grotesk\',sans-serif', fontSize: '11px', letterSpacing: '.14em', textTransform: 'uppercase', color: 'var(--sur)', marginBottom: '24px' }}>Waypoint 05 · Plan the trip</div>
        <div style={{ display: 'grid', gridTemplateColumns: 'auto minmax(0,1fr)', gap: '64px', alignItems: 'center' }} data-cols="1">
          <div data-dock="1" data-screen="createTrip" data-scale="0.58" data-kind="push" data-flow="createTrip,tripDetail,itinerary"></div>
          <div>
            ...
            <div data-rv="1" style={{ display: 'flex', flexWrap: 'wrap', gap: '8px 14px', marginTop: '22px', maxWidth: '620px', fontFamily: '\'Space Grotesk\',sans-serif', fontSize: '11px', letterSpacing: '.14em', textTransform: 'uppercase', color: 'var(--sur)' }}>
