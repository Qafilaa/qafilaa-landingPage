// Generated from `Qafilaa Site v3.dc.html` (handoff 14), lines 791-817.
...
export function NoSignal() {
  return (
    <section id="offline" data-sec="No signal" data-tone="paper" data-pad="1" style={{ position: 'relative', zIndex: '5', padding: '110px 56px 110px 132px' }}>
        <div data-plot="1" style={{ fontFamily: '\'Space Grotesk\',sans-serif', fontSize: 'var(--qf-fs-11)', letterSpacing: '.14em', textTransform: 'uppercase', color: 'var(--sur)', marginBottom: '24px' }}>Waypoint 18 · When there is no signal</div>
        ...
        <p data-rv="1" style={{ fontSize: 'var(--qf-fs-18)', lineHeight: '1.6', color: 'var(--mut)', maxWidth: '64ch', margin: '20px 0 0' }}>Every screen reads from disk first. Every action you take is written locally and syncs when the road gives you a bar back. Nothing you do is lost because a mountain got in the way.</p>
        <div style={{ marginTop: '30px', maxWidth: '760px' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', fontFamily: '\'Space Grotesk\',sans-serif', fontSize: 'var(--qf-fs-11)', letterSpacing: '.14em', textTransform: 'uppercase', color: 'var(--sur)' }}>
        ...
        <div data-rv="1" style={{ display: 'flex', flexWrap: 'wrap', gap: '8px 12px', marginTop: '16px', alignItems: 'baseline', fontFamily: '\'Space Grotesk\',sans-serif', fontSize: 'var(--qf-fs-11)', letterSpacing: '.14em', textTransform: 'uppercase', color: 'var(--sur)' }}>
        ...
        <div data-rv="1" style={{ display: 'flex', flexWrap: 'wrap', gap: '8px 14px', marginTop: '26px', fontFamily: '\'Space Grotesk\',sans-serif', fontSize: 'var(--qf-fs-11)', letterSpacing: '.14em', textTransform: 'uppercase', color: 'var(--sur)' }}>
        ...
        <details className="qf-rcpt" data-rv="1" style={{ marginTop: '12px', maxWidth: '680px' }}>
          <summary style={{ cursor: 'pointer', fontFamily: '\'Space Grotesk\',sans-serif', fontSize: 'var(--qf-fs-11)', letterSpacing: '.14em', textTransform: 'uppercase', color: 'var(--acc)' }}>For the technically curious +</summary>
